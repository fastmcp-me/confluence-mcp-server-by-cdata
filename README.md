[![Add to Cursor](https://fastmcp.me/badges/cursor_dark.svg)](https://fastmcp.me/MCP/Details/1751/confluence-mcp-server-by-cdata)
[![Add to VS Code](https://fastmcp.me/badges/vscode_dark.svg)](https://fastmcp.me/MCP/Details/1751/confluence-mcp-server-by-cdata)
[![Add to Claude](https://fastmcp.me/badges/claude_dark.svg)](https://fastmcp.me/MCP/Details/1751/confluence-mcp-server-by-cdata)
[![Add to ChatGPT](https://fastmcp.me/badges/chatgpt_dark.svg)](https://fastmcp.me/MCP/Details/1751/confluence-mcp-server-by-cdata)
[![Add to Codex](https://fastmcp.me/badges/codex_dark.svg)](https://fastmcp.me/MCP/Details/1751/confluence-mcp-server-by-cdata)
[![Add to Gemini](https://fastmcp.me/badges/gemini_dark.svg)](https://fastmcp.me/MCP/Details/1751/confluence-mcp-server-by-cdata)

# confluence-mcp-server-by-cdata
CData's Model Context Protocol (MCP) Server for Confluence

:heavy_exclamation_mark: This project builds a local, read-only MCP server. For fully remote MCP access, check out the first managed MCP platform: [CData Connect AI](https://www.cdata.com/ai/). For locally hosted, full read, write, update, delete, and action capabilities and a simplified setup, check out our [CData MCP Server for Confluence](https://www.cdata.com/drivers/confluence/download/mcp/).
## Purpose
We created this read-only MCP Server to allow LLMs (like Claude Desktop) to query live data Confluence supported by the [CData JDBC Driver for Confluence](https://www.cdata.com/drivers/confluence/jdbc/).
...
2. Download and install the CData JDBC Driver for {source}: [https://www.cdata.com/drivers/confluence/download/jdbc](https://www.cdata.com/drivers/confluence/download/jdbc/)
...
5. Create a `.prp` file for your JDBC connection (e.g. `confluence.prp`) using the following properties and format:
